//! Integration tests for Redis blocking commands
//!
//! These tests cover blocking operations:
//! - BLPOP, BRPOP (blocking list pops)
//! - BLMOVE, BRPOPLPUSH (blocking list moves)
//! - BZPOPMIN, BZPOPMAX (blocking sorted set pops)
//! - Timeout behavior
//!
//! Run with: cargo test --test integration_blocking
