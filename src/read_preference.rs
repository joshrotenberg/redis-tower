//! Read preference for routing commands to master or replica nodes
//!
//! This module provides traits and types for determining whether commands
//! should be routed to master or replica nodes. This is useful for both
//! Redis Cluster and Redis Sentinel deployments.

/// Read preference for command routing
...
/// # Example
/// ```
/// use redis_tower::read_preference::ReadOnly;
