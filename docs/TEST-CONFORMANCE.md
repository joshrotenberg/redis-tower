...
The scoreboard-scoped packages compile **720 integration tests** across **41 test binaries**. **205** tests are marked `#[ignore]` because they need explicit infrastructure; workflow selectors, rather than the annotation alone, determine whether they run.
