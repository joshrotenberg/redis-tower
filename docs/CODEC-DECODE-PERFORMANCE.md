...
on macOS arm64 at source `a93af55ce126b9d2a45d5d2522c6119bd32aa6d1`
...
samples of 20 iterations and are directional mechanism evidence, not Redis
client throughput or a cross-host performance claim.
...
|---|---:|---:|---:|---:|
| 512 five-byte replies; historical whole-buffer copy | 656,640 B | 708,352 B | 708,352 B | 54,374 ns |
| 512 five-byte replies; production first-frame copy | 2,560 B | 54,272 B | 54,272 B | 37,226 ns |
| 512 five-byte replies; split/shared comparison | 0 B | 39,464 B | 39,464 B | 12,511 ns |
| 128 mixed replies (71,296 wire bytes); historical whole-buffer copy | 4,630,640 B | 4,718,832 B | 3,576,560 B | 97,298 ns |
| 128 mixed replies; production first-frame copy | 71,296 B | 158,720 B | 158,544 B | 15,997 ns |
| 128 mixed replies; split/shared comparison | 0 B | 85,160 B | 85,160 B | 5,474 ns |
...
|---|---:|---:|---:|
| Historical whole-buffer copy | 262,178 B | 262,202 B | 8,462 ns |
| Production first-frame copy | 23 B | 47 B | 3,623 ns |
| Split/shared comparison | 0 B | 262,218 B | 3,778 ns |
